    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="experience.php  "class="active text-white">Experiences</a></li>
  ...
  <main class="main">
    ...
    <section id="resume" class="resume section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2 class="text-white"><?php echo titleExperience(1)?></h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="resume-title text-white"><?php echo titleExperience(2)?></h3>

            <div class="resume-item pb-0">
              <h4 class="text-white "><?php echo descriptionExperience(2)?></h4>
              <p class="text-white"><em class="text-white"><?php echo quoteExperience(2)?> </em></p>
            
            </div><!-- Edn Resume Item -->

            <h3 class="resume-title text-white"><?php echo titleExperience(3)?></h3>
            <div class="resume-item">
              <h4 class="text-white"><?php echo titleExperience(3)?></h4>
              <p class="text-white"><?php echo quoteExperience(3)?></p>
            </div><!-- Edn Resume Item -->
          ...
          <h3 class="resume-title text-white"><?php echo titleExperience(4)?></h3>
            <div class="resume-item">
              <h4 class="text-white"><?php echo titleExperience(4)?></h4>
              <p class="text-white"><?php echo quoteExperience(4)?></p>
            </div><!-- Edn Resume Item -->
